...
weight: 4
tags: []
image: img/wiskunde_1g_vgl_functies-1.png
---
...
<Annot xTarget={7/3} yTarget={5/3} xAnnot={6} yAnnot={3} anchorAngleAnnot={-135} anchorAngleTarget={0}>
Snijpunt
</Annot>
</Plot>

Het oranje punt duidt het <Orange>snijpunt</Orange> aan van de twee functies. Hoe kunnen we de coördinaten van dit snijpunt vinden?
...
oplossen](../oplossen), vinden we de $x-$coördinaat van het snijpunt van
$\green{f}$ en $\blue{g}$:
...
Als we een <Orange>nulwaarde</Orange> van een functie in die functie stoppen, komt er $0$ uit de functie.
...
En we krijgen een vergelijking! Wanneer we deze oplossen, vinden we de <Orange>nulwaarde</Orange> van de functie.
...
<Annot xTarget={4} yTarget={0} xAnnot={6} yAnnot={3}>
