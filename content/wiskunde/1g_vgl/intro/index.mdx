...
De bedoeling van een vergelijking is meestal om te zoeken **welk(e) getal(len)** we in plaats van de onbekende(n) <Mute>(meestal gewoon $x$)</Mute> kunnen zetten **zodat de gelijkheid klopt**. Die getallen noemen we de _oplossingen_ van de vergelijking.
...
<Expand title="Uitbreiding: Meerdere oplossingen">
...
<Attention title="Oplossingsverzameling">
