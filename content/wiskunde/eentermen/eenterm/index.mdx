...
bij $x$ een macht van $\orange{1}$ staat <Mute>(die schrijven we niet)</Mute> en bij $y$ een macht van $\blue{3}$: $-4x^\orange{1}y^\blue{3}$ en
$\orange{1} + \blue{3} = 4$.
...
**<Orange>tweede graad in $x$</Orange>** en van de
**<Blue>derde graad in $y$</Blue>**.
