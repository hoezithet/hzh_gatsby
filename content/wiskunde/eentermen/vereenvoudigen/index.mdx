...
[variabelen](../variabelen) even weglaten. Vervolgens reken je de bewerking die
er staat gewoon uit:
...
eenterm _rationaal_ zijn <Mute>(reëel mag ook)</Mute>, mogen we ze dus van
plaats veranderen.
...
Waarbij $a, \orange{n}, \blue{m} \in \mathbb{Q}$ <Mute>(of $\mathbb{R}$ mag ook)</Mute>.
