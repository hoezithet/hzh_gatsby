...
image: img/wiskunde_functies_nulpunten-1.png
---
...
_nul_ <Mute>(uiteraard)</Mute>.

Als de nulwaarde bijvoorbeeld $\orange{-2}$ is,
...
De twee nulpunten zijn aangeduid in het **<Orange>oranje</Orange>**.

<Plot xColor="gray" yColor="gray">
  <Fx fx={x => -Math.pow(x, 2) + 9}/>
  <Point x={3} y={0} color="orange" size={10}/>
  <Annot xTarget={3} yTarget={0} xAnnot={6} yAnnot={2}>Nulpunt</Annot>
  <Point x={-3} y={0} color="orange" size={10}/>
  <Annot xTarget={-3} yTarget={0} xAnnot={-6} yAnnot={2}>Nulpunt</Annot>
</Plot>
