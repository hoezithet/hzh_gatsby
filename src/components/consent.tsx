...
class ConsentBanner extends React.Component {
    ...
    handleAccept() {
        ...
        this.props.cookies.set("gatsby-gdpr-google-tagmanager", this.state.checkedGtCookie, {
            path: "/",
            maxAge: 2592000,
        });
        this.props.cookies.set("gatsby-gdpr-google-analytics", this.state.checkedGaCookie, {
            path: "/",
            maxAge: 2592000,
        });
    }
    ...
    render() {
        const prefs = this.state.showPrefs ? (
            <Grid item xs={12}>
                <FormGroup row>
                    <FormControlLabel
                        control={
                            <Checkbox
                                ...
                                checked={this.state.checkedGaCookie}
                                onChange={this.handleChangePrefs}
                                name="checkedGaCookie"
                                color="primary"
                            />
                        }
                    ...
                    <FormControlLabel
                        control={
                            <Checkbox
                                id="tagmanager-cookies-checkbox"
                                checked={this.state.checkedGtCookie}
                                onChange={this.handleChangePrefs}
                                name="checkedGtCookie"
                                color="primary"
                            />
                        }
                    ...
                    <Paper>
                        <Grid container spacing={2} justify="space-between" alignItems="center">
                            <Grid id="cookie-consent-text" item>
                                Wij gebruiken cookies. 🍪 Lees <Link to="/cookies">hier</Link> wat die cookies juist
                                zijn en waarom wij ze nodig hebben.
                            </Grid>
                            ...
                            <Grid item>
                                <Grid container direction="row" alignItems="center" spacing={2}>
                                    ...
                                    <Grid item>
                                        <Button id="adjust-cookies-btn" disableElevation onClick={this.handleShowPrefs}>
                                            {this.state.showPrefs ? "Verberg" : "Wijzig"} voorkeuren
                                        </Button>
                                    </Grid>
                                </Grid>
                            </Grid>
