...
**uitkomst moeten afronden tot op 1 cijfer na de komma** <Mute text="(afronden
op de tienden dus)" />. De uitkomst van de berekening zelf is:
...
overblijven <Mute text="($7$ en $6$)" />. We moeten dus afronden op de
duizendsten <Mute text="(3 plaatsen na de komma)" />:

$$0{,}07\orange{6}\gold{8}7134 \approx 0{,}07\orange{7}$$

## Samengevat

<Attention title="Benaderingsregels">
