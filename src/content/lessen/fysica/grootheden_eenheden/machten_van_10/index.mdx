...
\blue{10^c}$ <Mute text="(met $a, b, c \in \mathbb{R}$)" />:

Vermenigvuldig $a \cdot 10^b$ met
<span class="blue">$10^{c}$ om de juiste macht van 10 te hebben</span> en met
<span class="orange">$10^{-c}$ om alles gelijk te houden</span> aan $a \cdot 10^b$.
