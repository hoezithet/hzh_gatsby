...
**prefixen**. Een prefix <Mute text="(of voorvoegsel)" /> schrijf je telkens
_vóór_ de eenheid. Elke prefix stelt een bepaalde macht van 10 voor. Je bent
ongetwijfeld al veel prefixen tegengekomen. De $\si{k}$ <Mute text="(kilo)" />
in $\si{kg}$ <Mute text="(kilogram)" />, bijvoorbeeld, is een prefix. Of de
$\si{c}$ <Mute text="(centi)" /> in $\si{cm}$ <Mute text="(centimeter)" />.
...
De eenheid van volume is $\si{m}^3$ <Mute text="(kubieke meter)" />.  Als er
