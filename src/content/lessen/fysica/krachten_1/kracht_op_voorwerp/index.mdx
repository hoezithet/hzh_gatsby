...
weight: 6
image: img/schaatsbaan_setup.png
---
...
-   [de zwaartekracht](zwaartekracht) $\red{\vec{F}_{zM}}$ die de aarde uitoefent
    op Maria,
-   [de normaalkracht](normaalkracht_en_gewicht) $\red{\vec{F}_{nM}}$ die de schaatsbaan
    uitoefent op Maria.
...
<Attention title="Krachten op een voorwerp">
...
<Attention title="Krachten samenleggen in massapunt">
