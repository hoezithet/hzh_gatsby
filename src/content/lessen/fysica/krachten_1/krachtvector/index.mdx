...
<Mute text="(hoe hard je trekt of duwt)" /> als een **richting** en **zin**
<Mute text="(waarheen je trekt of duwt)" />. Daarom is kracht een [vectoriële
...
<Mute text="(merk op: geen pijltje op de $F$)" />.
