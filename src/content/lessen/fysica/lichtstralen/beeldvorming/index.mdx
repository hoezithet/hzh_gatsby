...
het voorwerp <Mute text="(bv. de sinaasappel)" />.
...
De camera obscura <Mute text='(Latijn voor "donkere kamer")' /> was een van de
...
wanden een klein gaatje naar de <Mute text="(verlichte)" />
buitenwereld.
...
Omdat lichtstralen zich <Mute text="door een homogene middenstof" />
