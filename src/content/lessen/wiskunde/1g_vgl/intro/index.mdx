...
De bedoeling van een vergelijking is meestal om te zoeken **welk(e) getal(len)** we in plaats van de onbekende(n) <Mute text="(meestal gewoon $x$)" /> kunnen zetten **zodat de gelijkheid klopt**. Die getallen noemen we de _oplossingen_ van de vergelijking.
