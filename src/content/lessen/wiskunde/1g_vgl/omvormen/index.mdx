...
We zeggen dat we de vergelijking

$$
x + 2 = -3x - 1
$$

hebben _omgevormd_ naar vergelijking

$$
x - 4 = - 3x - 7
$$

door in het linker- en rechterlid _dezelfde bewerking_ te doen (namelijk links
en rechts $\orange{6}$ aftrekken). Achter elkaar schrijven we de omvorming als
volgt:
...
2x - 6 &= 8 - x\\
 ...
 \Leftrightarrow 2x - 6 \orange{+ x} &= 8 \cancel{- x \orange{+ x}}\\
 \Leftrightarrow \orange{3x} - 6 &= 8\\
\end{aligned}
$$
...
3x - 6 &= 8\\
 ...
 \Leftrightarrow 3x \cancel{- 6 \orange{+ 6}} &= 8 \orange{+6}\\
...
3x &= 14\\
 ...
 \Leftrightarrow \cancel{\frac{3}{\orange{3}}}\cdot x &= \frac{14}{\orange{3}}\\
