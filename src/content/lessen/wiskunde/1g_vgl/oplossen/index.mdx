...
In de eerste stap trekken we $b\_{links}$ <Mute text="($= -2$)" /> af van het linker- en rechterlid:
$$
\begin{aligned}
\Leftrightarrow -5x - 2 &= 12\\
...
$$
a_{links}\cdot x + b\_{links} = a\_{rechts}\cdot x + b\_{rechts}
$$
...
3. Breng alle getallen naar de rechterkant door van de vergelijking eerst
   $b\_{links}$ af te trekken zodat je iets van de vorm 
$$
a\cdot x = b
$$
