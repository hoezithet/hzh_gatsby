...
Dat betekent dat we in één keer in **alle x-waarden** <Mute text="(waarin
$f(x)$ afleidbaar is)" /> de afgeleide berekenen!  😮 Dat noemen we de
...
x-waarde <Mute text="(waarin $f(x)$ afleidbaar is)" /> in invullen en vinden we
...
welke x-waarde <Mute text="(waarin $f(x)$ afleidbaar is)" /> berekenen! In de
