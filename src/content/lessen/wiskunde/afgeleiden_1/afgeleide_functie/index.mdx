...
tweedegraadsfunctie."
image: img/zonder_met_afgeleide_fx.png
---

In de vorige les zagen we hoe je de [afgeleide voor een bepaalde
x-waarde](../afgeleide) van een functie $f(x)$ kan berekenen. Lees die les
...
al het werk herhalen van de [vorige les](../afgeleide).
...
afgeleide](../afgeleide) kan berekenen. Daarvoor vulden we de x-waarde in in
...
Lees zeker [onze introductie tot afgeleiden](../afgeleide) eens na als je die
...
![Uitwerking van $f(x + \Delta x)$](img/f_delta_x_uitwerking_stripped.png)
![Uitwerking van $f(x + \Delta x), met uitleg$](img/f_delta_x_uitwerking.png)
...
![Uitwerking van de teller van de definitie van een afgeleide functie voor onze tweedegraadsfunctie.](img/afgeleide_teller_uitwerking_stripped.png)
![Uitwerking van de teller van de definitie van een afgeleide functie voor onze tweedegraadsfunctie, met uitleg per stap.](img/afgeleide_teller_uitwerking.png)
...
![$\Delta x$ wegdelen uit teller en noemer van de afgeleide.](img/delta_x_wegdelen_stripped.png)
![$\Delta x$ wegdelen uit teller en noemer van de afgeleide, met uitleg.](img/delta_x_wegdelen.png)
...
![Uitwerking van de limiet om de afgeleide functie te berekenen.](img/limiet_uitrekenen_stripped.png)
![Uitwerking van de limiet om de afgeleide functie te berekenen, met uitleg.](img/limiet_uitrekenen.png)
...
[vorige les](../afgeleide) hebben we bijvoorbeeld de afgeleide van de functie
