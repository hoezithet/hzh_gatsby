...
**breuk** met in de teller <Mute text="(boven)" /> het verschil van posities en 
in de noemer <Mute text="(onder)" /> het
...
> <Mute text="(zoals positie en tijd)" /> een functie is, kan je altijd onze
...
waarbij de **tijd op de x-as** <Mute text="(horizontale as)" /> staat en de
**positie op de y-as** <Mute text="(verticale as)" />:
...
-   In de teller <Mute text="(boven)" /> staat $\green{f(x\_2)} -
  \green{f(x\_1)}$. Daarmee berekenen we het verschil van de functiewaarden van
    ...
    tussen $x\_1$ en $x\_2$.
-   In de noemer <Mute text="(onder)" /> staat dan weer het verschil van die
    ...
    $x-$eenheid** <Mute text="(bv. per seconde)" /> tussen $x\_1$ en $x\_2$" in
...
1. Vervang $\orange{x\_2} - \orange{x\_1}$ door $\orange{\Delta x}$: 
$$
\frac{\green{f(x\_2)} - \green{f(x\_1)}}{\orange{\Delta x}}
$$

2. Vervang $x\_2$ door $x\_1 + \Delta x$: 
$$
\frac{\green{f(x\_1 + \Delta x)} - \green{f(x\_1)}}{\orange{\Delta x}}
$$

3. Vervang $x\_1$ overal door $a$: 
$$
