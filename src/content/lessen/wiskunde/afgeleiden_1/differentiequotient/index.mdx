...
Daarvoor moeten we de **afgelegde afstand** <Mute>(hoeveel (kilo)meter?)</Mute> delen door de **tijd die nodig was** <Mute>(hoeveel uur of seconden?)</Mute> om die afstand af te leggen:
