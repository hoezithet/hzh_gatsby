...
<Expand title="Waar is het maalteken naartoe?">
...
De factoren van een eenterm kunnen <Mute text="(machten van)" /> getallen of
...
bij $x$ een macht van $\orange{1}$ staat <Mute text="(die schrijven we niet)"
/> en bij $y$ een macht van $\blue{3}$: $-4x^\orange{1}y^\blue{3}$ en
$\orange{1} + \blue{3} = 4$.
...
**<span class="orange">tweede graad in $x$</span>** en van de
**<span class="blue">derde graad in $y$</span>**.
...
<Attention title="Wat is een eenterm?">
...
<Attention title="Gelijksoortige eentermen">
