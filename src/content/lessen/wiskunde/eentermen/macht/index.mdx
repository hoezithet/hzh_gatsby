...
herhalen. Stel dat we de volgende macht moeten uitrekenen <Mute text="(waarbij
$a \in \mathbb{R}$)" />:
...
<Attention title="De macht van een eenterm berekenen">
...
<Attention title="De wortel van een eenterm berekenen">
