...
title_img: "/lessen/wiskunde/eentermen/variabelen/img/living_no_dims.png"
---
...
oppervlakte <Mute text='(van het Engelse "Area")' />, $\orange{l}$ voor de
...
$A$ <Mute>(de oppervlakte)</Mute> gelijk is aan $20~\si{m}^2$.

![](img/living_area_computed.png)

## Samengevat

<Attention title="Een variabele stelt een element van een verzameling voor">
...
<Attention title="Variabelen invullen">
