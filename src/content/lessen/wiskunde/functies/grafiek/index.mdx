...
title_img: "/lessen/wiskunde/functies/grafiek/plt/single_x.png"
---
...
In de laatste rij van die waardentabel is $\orange{x = 5}$ en $\green{y =
1{,}5}$. We kunnen dit voorstellen door een puntje met coördinaten
$(\orange{5};~\green{1{,}5})$. <Mute>(Probeer eens op het puntje te
klikken.)</Mute>

<Bokeh plot="plt/single_x" />


Zo kunnen we alle rijen in onze waardentabel voorstellen als puntjes in een
assenstelsel.

<Bokeh plot="plt/multiple_x" />
...
<Bokeh plot="plt/loads_of_x" />

We hebben nu zoveel puntjes op ons assenstelsel dat we eigenlijk niet meer zien
dat het _aparte_ puntjes zijn. Het zijn wel degelijk aparte puntjes <Mute
text="(beweeg maar eens over de grafiek)" />, maar we zien het als **één
