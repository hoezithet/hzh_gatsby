...
Welke x-waarden welk teken <Mute text="(positief/negatief/nul)" /> opleveren
...
2. Zoek alle [nulpunten](nulpunten) en zet ze van klein naar groot <Mute text="(volgens x-waarde)" /> tussen de grenzen van het domein;
3. Vind de tekens van $y$ tussen alle x-waarden in het schema <Mute text="(tenzij die x-waarden buiten het domein liggen)" />.

We werken deze stappen uit voor de <Mute text="(reële)" /> functie met
...
De x-waarden die in een tekenschema staan <Mute text="(de bovenste rij)" />,
zijn _ofwel nulwaarden_ <Mute text="($-3$ en $3$ in het vorige voorbeeld)"/>
_ofwel grenzen van het domein_ <Mute text="($-\infty$ en $+\infty$ in het
voorbeeld)"/>. Er zijn geen andere x-waarden nodig. Dat is omdat **het teken
