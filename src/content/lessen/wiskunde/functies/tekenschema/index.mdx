...
<Mute text='(ook wel "tekentabel" of "tekenverloop" genoemd)'/>.
Als de [grafiek van een functie](grafiek) is gegeven, kunnen we zien waar de
functiewaarden <Mute text="(of de y-waarden)" /> _positief_, _negatief_ of _nul_
zijn.
...
De x-waarden die in een tekenschema staan <Mute text="(de bovenste rij)" />, zijn _ofwel nulwaarden_
<Mute text="($-3$ en $3$ in het vorige voorbeeld)"/> _ofwel grenzen van het domein_
<Mute text="($-\infty$ en $+\infty$ in het voorbeeld)"/>. Er zijn geen andere
