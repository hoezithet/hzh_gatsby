...
ongeveer $0{,}64~\si{s}$ op de grond zal zijn. <Mute text="(Probeer dit thuis gerust ook eens uit door een balletje van die hoogte te laten vallen en de valtijd te meten met een chronometer.)" />
...
<Attention title="Verwar de haakjes niet met een vermenigvuldiging!">
...
<Attention title="Wat is een functievoorschrift?">
...
<Attention title="De functiewaarde van een x-waarde vinden">
