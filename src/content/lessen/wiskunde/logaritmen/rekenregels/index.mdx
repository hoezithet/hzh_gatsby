...
Net zoals er geen rekenregel bestaat voor de som of het verschil van machten, bestaat er ook **geen rekenregel voor de logaritmen van een som of verschil**.
...
Om **de logaritme van een quotiënt** te berekenen, gaan we op **gelijkaardige manier** te werk. Hier geven we het **bewijs**, gebruikmakend van één van de **<Orange>basisformules</Orange>** en de regels voor **rekenen met machten**.
...
$$
^a\!\log{\frac{1}{x}} = \cancel{^a\!\log 1} - \ ^a\!\log x = - \ ^a\!\log x
$$
