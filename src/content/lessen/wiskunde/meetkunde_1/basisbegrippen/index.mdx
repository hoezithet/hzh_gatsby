...
![Collineaire punten](img/collineaire_punten_stripped.png)
![Collieaire punten, met uitleg](img/collineaire_punten.png)
...
![Een lijnstuk is een lijn die stopt in punten. We noteren dit met twee rechte haakjes, eentje rond elk grenspunt: [AB]. Een rechte loopt doorheen de punten, zoals eerder reeds vermeld. We noteren geen vierkante haakjes, maar gewoon AB.](img/lijnstuk_rechte_stripped.png)
...
> De [les over grootheden en eenheden](/lessen/fysica/grootheden_eenheden/intro) gaat dieper in op deze eenheden, zeker eens de moeite om te lezen!
...
![Aan beide voorwaarden moet voldaan worden. De lengte tussen punt M en punten A en B moet gelijk zijn en M moet op het lijnstuk liggen (dezelfde drager).](img/definitie_midden_stripped.png)
