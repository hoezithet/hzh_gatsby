...
![Een illustratie van een cirkel.](img/cirkel.png)
...
![De diameter is tweemaal de straal.](img/straal_diameter.png)
...
Daarnaast is er ook nog een **middellijn**. Dit is een **rechte** <Mute text="of lijn"/> die **door het middelpunt** van de cirkel gaat. Een hoek waarvan het **hoekpunt** samenvalt met het **middelpunt**, noemt men een **middelpuntshoek**.

![Een illustratie van koorde, middellijn en middelpuntshoek.](img/koorde_middellijn.png)

## Samengevat
<Attention title="De cirkel">
...
<Attention title="Lijnen in de cirkel">
