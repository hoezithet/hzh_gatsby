...
2. **Machten** <Mute text="(en wortels)" /> hebben voorrang op
   **vermenigvuldigingen** <Mute text="(en delingen)" />;
3. **Vermenigvuldingen** <Mute text="(en delingen)" /> hebben voorrang op
   **optellingen** <Mute text="(en aftrekkingen)" />;
4. **Optellingen** <Mute text="(en aftrekkingen)" /> hebben voorrang op **niets**.

</Attention>

De <Mute text="lichtgrijze" /> bewerkingen hebben dezelfde voorrang als de
...
_"Vermenigvuldingen hebben voorrang op optellingen <Mute text="(en aftrekkingen)" />"_, dus:
