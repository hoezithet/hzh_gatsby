...
---
Wij mensen hebben graag dat alles kort en netjes genoteerd wordt. 🖋️ Ook in
...
> Voor je aan deze les begint, fris je best eerst even de [les over vermenigvuldigen](./rekenen_gehele_getallen) op! 😉
...
even het voorbeeld uit de inleiding <Mute text="($5 \cdot 5 \cdot 5$)"/>, waarvan we weten dat het gelijk is aan
$5^3$. Hieruit kunnen we het volgende opmaken:

$$
 \underbrace{5 \cdot 5 \cdot 5}_{\orange{3}~\text{factoren}} = 5\orange{^3} = 125
$$
...
2. Als de **exponent $1$** is, dan is de uitkomst altijd **het grondtal** zelf. Immers, een product met $1$ factor is die factor zelf.
