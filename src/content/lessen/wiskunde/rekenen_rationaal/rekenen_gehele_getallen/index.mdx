...
{{< expand "Waarom is $8$ het tegengestelde van $-8$?" >}}
...
{{< attention "Rekenregel voor het teken van een vermenigvuldiging" >}}
...
{{< attention "Eigenschappen van de optelling van gehele getallen" >}}
...
{{< attention "Teken van een vermenigvuldiging" >}}
...
{{< attention "Eigenschappen van de vermenigvuldiging van gehele getallen" >}}
...
{{< attention "Teken van een deling" >}}
