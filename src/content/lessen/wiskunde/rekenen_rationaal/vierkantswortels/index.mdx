...
weight: 6
image: ./img/vierkantswortel_terminologie.png
...
![Een macht bestaat uit een grondtal en een exponent. In dit voorbeeld is 5 het grondtal en 3 de exponent.](img/vierkantswortel_terminologie.png)
