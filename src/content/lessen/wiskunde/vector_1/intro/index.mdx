...
weight: 1
draft: false
image: ./img/vector_is_arrow.png
description: "In deze les leggen we uit wat een vector is."
tags: ["Vector"]
---
...
als $\norm{\vec{v}}$ of ook wel gewoon als $v$ <Mute>(geen pijltje op de
$v$)</Mute>.
...
<Attention title="Een vector is een pijl met een grootte, richting en zin">
