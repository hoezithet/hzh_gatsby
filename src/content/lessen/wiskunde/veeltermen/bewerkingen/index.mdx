...
We gaan ervan uit dat de variabelen <Mute text="($a$ en $b$)" /> reële getallen
zijn <Mute text="(of rationale getallen, maakt niet uit)" />. We mogen dus de
...
1. Laat de **haakjes weg** en **verander de toestandstekens**
   <Mute text="($+$ en $-$)" /> van de termen van de veelterm die **na het
   minteken** stond.
2. Je krijgt nu één lange veelterm. **Vereenvoudig en herleid** die veelterm.
