...
Wanneer een veelterm [variabelen](../eentermen/variabelen) bevat, geeft de veelterm enkel een **beschrijving van een berekening**. De veelterm zegt enkel **hoe** je een uitkomst kan berekenen. Wanneer we echter de **variabelen vervangen** door getallen, kan de veelterm ook gelijk worden aan een getal. Dat getal noemen we een **getalwaarde van de veelterm**. In deze les leren we hoe we zo een getalwaarde kunnen berekenen.
...
<Attention title="Negatieve getallen tussen haakjes zetten">
...
<Attention title="Getalwaarde van een veelterm">
